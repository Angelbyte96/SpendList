				...
				<form action="">
					...
					<div className="m-2 flex flex-col gap-1 rounded-xl border p-2 md:gap-2 md:p-4">
						...
						<div className="flex w-full flex-col items-start gap-3 sm:flex-row sm:items-center">
							...
							/>
							<button className="flex w-full items-center justify-center gap-2 rounded-lg bg-blue-800 px-3 py-1.5 text-white transition-colors hover:bg-blue-900 sm:w-auto">
								<Plus size={18} />
								<span>Agregar</span>
							</button>
						</div>
